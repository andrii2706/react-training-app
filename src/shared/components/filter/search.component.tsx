...
export const SearchComponent = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col bg-gray-400 rounded-lg p-5">
      <h2 className="text-3xl">Filter</h2>
      <div className="flex justify-center items-center">
        <form
          className="flex justify-center items-center"
          onSubmit={handleSubmitFilter(getDataFromForm)}
        >
          <input className="p-4" placeholder="Incert Name of user" {...filter('name')} />
          <fieldset className="fieldset  px-5">
            <legend className="fieldset-legend">Browsers</legend>
            <select defaultValue="Pick a browser" className="select" {...filter('gender')}>
          ...
          <fieldset className="fieldset px-5">
            <legend className="fieldset-legend">Browsers</legend>
            <select defaultValue="Pick a browser" className="select" {...filter('species')}>
          ...
          <button className="btn btn-soft ml-5" onClick={clearForm}>
            Clear filter
          </button>
        </form>
      </div>
